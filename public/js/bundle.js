...
/***/ function(module, exports, __webpack_require__) {
	...
	React.render(React.createElement(Demo, null), document.getElementById("component"));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var data = [{ id: 1, text: "Jack" }, { id: 2, text: "John" }, { id: 3, text: "Johnny" }, { id: 4, text: "Mary" }, { id: 5, text: "Marco" }, { id: 6, text: "Ted" }, { id: 7, text: "Jared" }, { id: 8, text: "Nina" }];
	...
	var Demo = React.createClass({
		...
		liveUpdate: function liveUpdate(id) {
		...
		render: function render() {
			return React.createElement(
				...
				React.createElement(
					...
					" ",
					React.createElement("span", { ref: "getValue" })
				),
				React.createElement(
					"div",
					null,
					"Live update: ",
					React.createElement("span", { ref: "liveValue" })
				),
				React.createElement(Autocomplete, { ref: "ac", onChange: this.liveUpdate, selected: this.state.selected, data: data })
			);
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Autocomplete = React.createClass({
		...
		getOptions: function getOptions() {
			...
			return this.props.data.filter(function (a) {
				return a.text.toLowerCase().indexOf(_this.state.filter.toLowerCase()) >= 0;
			}).map(function (e, i) {
				return React.createElement(
					"li",
					{ onClick: _this.setValue.bind(null, e), key: i },
					e.text
				);
			});
		},
		...
		unFocus: function unFocus() {
			...
			if (className.indexOf("active") > 0) {
				setTimeout(function () {
					_this.refs.suggestions.getDOMNode().className = className.replace("active", "");
				}, 150);
			}
		},
		componentWillReceiveProps: function componentWillReceiveProps(next) {
			if (next.selected) {
				...
				this.refs.textFilter.getDOMNode().value = next.data.filter(function (e) {
					return e.id == next.selected;
				})[0].text;
				if (!!this.props.onChange) {
		...
		shouldComponentUpdate: function shouldComponentUpdate(nextProps, nextState) {
			if (nextProps.selected == this.props.selected && nextProps.data.length == this.props.data.length && this.state.filter == nextState.filter) {
				return false;
			} else {
				return true;
			}
		...
		getDefaultValue: function getDefaultValue() {
			...
			if (!!this.props.selected) {
				return this.props.data.filter(function (e) {
					return e.id == _this.props.selected;
				})[0].text;
			} else {
				return "";
			}
		...
		render: function render() {
			return React.createElement(
				"div",
				{ className: "Autocomplete", onClick: this.setFocus },
				React.createElement("input", { onBlur: this.unFocus, ref: "textFilter", onChange: this.setFilter, defaultValue: this.getDefaultValue() }),
				React.createElement(
					"ul",
					{ ref: "suggestions" },
					this.getOptions()
